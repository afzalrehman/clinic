                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="input-block local-forms">
                                            ...
                                            <textarea class="form-control" name="known_allergies" rows="3" placeholder="Enter Known Allergies">{{ old('known_allergies') }}</textarea>
                                    ...
                                    <div class="col-12">
                                        <div class="input-block local-forms">
                                            ...
                                            <textarea class="form-control" name="chronic_illnesses" rows="3" placeholder="Enter Chronic Illnesses">{{ old('chronic_illnesses') }}</textarea>
