                                    ...
                                    <div class="col">
                                        <div class="doctor-table-blk">
                                            ...
                                            <div class="doctor-search-blk">
                                                ...
                                                <div class="add-group">
                                                    <a href="{{ route('clinic.department.create') }}"
                                                        class="btn btn-primary add-pluss ms-2"><img
                                                            src="{{ asset('assets/img/icons/plus.svg') }}"
                                                            alt=""></a>
                                                    <a href="{{ route('clinic.department') }}" class="btn btn-primary doctor-refresh ms-2"><img
                                                ...
                                                <td class="text-end">
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" href="{{url('clinic/department/edit/'.$item->id)}}"><i
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body text-center">
                                                            ...
                                                            <div class="m-t-20"> <a href="#" class="btn btn-white"
                                                                ...
                                                                <a href="{{ url('clinic/department/delete/' . $item->id) }}"
