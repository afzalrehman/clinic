    ...
    <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-md-6 position-blk">
                    <div class="morning-img">
                        <img src="{{asset('assets/img/morning-img-03.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="card report-blk">
                    <div class="card-body">
                        <div class="report-head">
                            <h4><img src="{{asset('assets/img/icons/report-icon-01.svg')}}" class="me-2" alt="">Heart Rate</h4>
                        </div>
            ...
            <div class="col-12 col-md-6 col-xl-3 d-flex">
                <div class="card report-blk">
                    <div class="card-body">
                        <div class="report-head">
                            <h4><img src="{{asset('assets/img/icons/report-icon-02.svg')}}" class="me-2" alt="">Temperature</h4>
                        </div>
            ...
            <div class="col-12 col-md-6 col-xl-3 d-flex">
                <div class="card report-blk">
                    <div class="card-body">
                        <div class="report-head">
                            <h4><img src="{{asset('assets/img/icons/report-icon-03.svg')}}" class="me-2" alt="">Blood Pressure</h4>
                        </div>
            ...
            <div class="col-12 col-md-6 col-xl-3 d-flex">
                <div class="card report-blk">
                    <div class="card-body">
                        <div class="report-head">
                            <h4><img src="{{asset('assets/img/icons/report-icon-04.svg')}}" class="me-2" alt="">Sleep</h4>
                        </div>
        ...
        <div class="row">
                        ...
                        <div class="card wallet-widget general-health">
                            <div class="circle-bar circle-bar2">
                                <div class="circle-graph2" data-percent="66">
                                    <b><img src="{{asset('assets/img/icons/health-img.svg')}}" alt=""></b>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="table-image">
                                                    <img width="28" height="28" class="rounded-circle" src="{{asset('assets/img/profiles/avatar-02.jpg')}}" alt=""> 
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-image">
                                                    <img width="28" height="28" class="rounded-circle" src="{{asset('assets/img/profiles/avatar-04.jpg')}}" alt=""> 
                                                    <h2>Andrea Lalema</h2>
                                                </td>
                                                <td>Dermotology</td>
                                                <td >10.05.2022 </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-image">
                                                    <img width="28" height="28" class="rounded-circle" src="{{asset('assets/img/profiles/avatar-05.jpg')}}" alt=""> 
            ...
            <div class="col-12 col-md-12 col-xl-5">
                ...
                <div class="treat-box mb-2">
                    <div class="user-imgs-blk">
                        <img src="{{asset('assets/img/profiles/avatar-03.jpg')}}" alt="">
                        <div class="active-user-detail flex-grow-1">
