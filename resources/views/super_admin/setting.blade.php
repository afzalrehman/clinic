                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            <form action="{{ url('/super-admin/logochange') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="settings-form">
                                    <div class="input-block">
                                        <label>Application Name <span class="star-red">*</span></label>
                                        <input type="text" name="application_name" value="{{$logo->application_name}}" class="form-control" placeholder="Enter Application Name">
                                    </div>
                                    <!-- Logo Input -->
                                    <div class="input-block">
                                        ...
                                        <div class="upload-images">
                                            <img src="{{ $logo->superadminlogo() }}" alt="Image">
                                    ...
                                    <div class="input-block">
                                        ...
                                        <!-- Error Message for Favicon -->
                                        @error('favicon')
                                            <small style="color: red; font-size:13px;">{{ $message }}</small>
                                        @enderror

                                        <div class="upload-images upload-size">
                                            <img src="{{ $logo->superadmin_favicon() }}" alt="Image">
                                            <a href="javascript:void(0);" class="btn-icon logo-hide-btn">
                                                <i class="feather-x-circle"></i>
                                            </a>
                                        </div>
