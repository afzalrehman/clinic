                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-block local-forms">
                                            ...
                                            <input type="text" class="form-control floating" value="{{$corrent_user->name}}" >
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-block local-forms">
                                            <label class="focus-label">UserName</label>
                                            <input type="text" class="form-control floating" value="{{$corrent_user->username}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-block local-forms ">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-block local-forms">
                                ...
                                <input type="text" class="form-control floating" value="{{$corrent_user->address}}">
                            </div>
                        </div>
                        {{-- <div class="col-md-6">
                            <div class="input-block local-forms">
                        ...
                        <div class="col-md-6">
                            <div class="input-block local-forms">
                                ...
                                <input type="text" class="form-control floating" value="{{$corrent_user->email}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-block local-forms">
                                <label class="focus-label">Phone Number</label>
                                <input type="text" class="form-control floating" value="{{$corrent_user->phone}}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-block local-forms">
                                ...
                                <input type="text" class="form-control floating" value="{{$corrent_user->education}}">
                            </div>
                        </div>
