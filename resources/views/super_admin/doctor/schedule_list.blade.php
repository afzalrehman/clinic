        ...
        <div class="content">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('superadmin.doctor_schedule') }}">Doctor Shedule </a></li>
                                        ...
                                        <div class="doctor-table-blk">
                                            ...
                                            <div class="doctor-search-blk">
                                                ...
                                                <div class="add-group">
                                                    ...
                                                    <a href="{{ route('superadmin.doctor_schedule') }}" class="btn btn-primary doctor-refresh ms-2"><img
