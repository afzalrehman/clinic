                    ...
                    <div class="col-sm-12">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a
                                    href="{{ route('superadmin.clinic') }}">Clinic </a></li>
                                                ...
                                                <div class="add-group">
                                                    <a href="{{ route('superadmin.clinic.create') }}"
                                                        class="btn btn-primary add-pluss ms-2"><img
                                                            ...
                                                            alt=""></a>
                                                    <a href="{{ route('superadmin.clinic') }}"
                                    ...
                                    <tbody>
                                        @foreach ($clinic_data as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->name }}</td>
                                                <td><a href="https://www.google.com/maps?q={{ $item->location_pin }}" target="_blank">{{ $item->location_pin }}</a></td>
                                                <td><a href="tel:{{ $item->phone_no }}">{{ $item->phone_no }}</a></td>
                                                <td>
                                                ...
                                                <td><a href="tel:">{{ $item->contact_person }}</a></td>
                                                ...
                                                ?>
                                                <td><button
                                                        class="custom-badge {{ $item->flag == 1 ? 'status-green' : 'status-pink' }}  ">{{ $flag[$item->flag] }}</button>
                                                </td>
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body text-center">
                                                            ...
                                                            <div class="m-t-20"> <a href="#" class="btn btn-white"
                                                                ...
                                                                <a href="{{ url('super-admin/clinic/delete/' . $item->id) }}"
