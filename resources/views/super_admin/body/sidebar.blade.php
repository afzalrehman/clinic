    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="index.html"><span class="menu-side"><img src="assets/img/icons/menu-icon-01.svg"
                ...
                <li>
                    <a href="{{route('superadmin.user')}}"><span class="menu-side"><img src="assets/img/icons/menu-icon-16.svg"
            ...
            <div class="logout-btn">
                <a href="{{route('logout')}}"><span class="menu-side"><img src="assets/img/icons/logout.svg"
