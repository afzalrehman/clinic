    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="index.html"><span class="menu-side"><img src="{{asset('assets/img/icons/menu-icon-01.svg')}}"
                    ...
                    <ul style="display: none;">
                        ...
                        <ul style="display: none;">
                            ...
                            <li><a href="edit-department.html">Edit Department</a></li>
                                            ...
                                            <!-- <li class="submenu">
                        <a href="#"><span class="menu-side"><img src="{{asset('assets/img/icons/menu-icon-07.svg')}}" alt=""></span> <span> Accounts </span> <span class="menu-arrow"></span></a>
                        <ul style="display: none;">
                            ...
                            <li><a href="provident-fund.html">Provident Fund</a></li>
                                            ...
                                            <!-- <li class="submenu">
                        <a href="#"><span class="menu-side"><img src="{{asset('assets/img/icons/menu-icon-09.svg')}}" alt=""></span> <span> Payroll </span> <span class="menu-arrow"></span></a>
                        <ul style="display: none;">
                            ...
                            <li><a href="salary-view.html"> Payslip </a></li>
                                            ...
                                            <!-- <li>
                        <a href="chat.html"><span class="menu-side"><img src="{{asset('assets/img/icons/menu-icon-10.svg')}}" alt=""></span> <span>Chat</span></a>
                        </li> -->
                                            <!-- <li class="submenu">
                                                <a href="#"><span class="menu-side"><img src="{{asset('assets/img/icons/menu-icon-11.svg')}}" alt=""></span> <span> Calls</span> <span class="menu-arrow"></span></a>
                                                <ul style="display: none;">
                ...
                <li class="submenu">
                    ...
                    <ul style="display: none;">
                        ...
                        <li><a href="mail-view.html">Mail View</a></li>
                                        ...
                                        <!-- <li class="submenu">
                                            <a href="#"><span class="menu-side"><img src="{{asset('assets/img/icons/menu-icon-13.svg')}}" alt=""></span> <span> Blog</span> <span class="menu-arrow"></span></a>
                                            <ul style="display: none;">
                ...
                <li>
                    <a href="{{route('superadmin.user')}}"><span class="menu-side"><img src="{{asset('assets/img/icons/menu-icon-16.svg')}}"
