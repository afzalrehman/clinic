                    ...
                    <div class="card chat-box">
                        <div class="chat-widgets">
                            ...
                            <div class="email-menu-blk">
                                <ul >
                                    <li class="active"><a href="{{route('superadmin.inbox')}}"><img src="assets/img/icons/inbox.svg" class="me-2" alt="img">Inbox<span class="comman-flex">50</span></a></li>
                                    <li><a href="{{route('superadmin.mail_view')}}"><img src="assets/img/icons/sent.svg" class="me-2" alt="img">Sent <span class="comman-flex">120</span></a></li>
